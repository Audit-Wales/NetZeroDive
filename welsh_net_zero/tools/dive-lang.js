(function (global) {
  const COPY = {
    en: {
      ...
      bodiesGrowthExploreBtn: 'See who they are',
      bodiesGrowthModalLabel: 'Reporting bodies by organisation type',
      bodiesGrowthModalClose: 'Close',
      exploreBtnHint: 'Pause video to explore',
      ...
      quotesSubtitle: 'A sample of quotes about leadership and prioritisation.',
      ...
      emissionsPerBodyTitle: 'Emissions per reporting body, 2021–2025',
      emissionsPerBodySubtitle: 'Total emissions divided by the number of reporting bodies each year.',
      emissionsPerBodyExploreBtn: 'See the breakdown by source',
      emissionsPerBodyModalLabel: 'Welsh public sector emissions by source',
      perBodyFactCaption: 'Analysing data for only the 67 public bodies that reported in both 2021-22 and 2024-25 — there has been an',
      perBodyFactSub: 'increase in reported carbon emissions',
      ...
      donutBody: 'Scope 3 emissions are indirect emissions. Scope 3 accounts for the bulk of emissions, but there is wide agreement that the data is not accurate enough to inform meaningful action.',
      donutCenterShareLabel: 'Total emissions',
      donutCenterUnit: 'tCO₂e',
      donutScope1Label: 'Scope 1',
      donutScope2Label: 'Scope 2',
      donutScope3Label: 'Scope 3',
      scopeTrendExploreBtn: 'See the 2021–2025 trend',
    ...
    cy: {
      ...
      bodiesGrowthExploreBtn: 'Gweld pwy ydynt',
      bodiesGrowthModalLabel: 'Cyrff adrodd yn ôl math o sefydliad',
      bodiesGrowthModalClose: 'Cau',
      exploreBtnHint: 'Seibiwch y fideo i archwilio',
      ...
      quotesSubtitle: 'Sampl o ddyfyniadau am arweinyddiaeth a blaenoriaethu.',
      ...
      emissionsPerBodyTitle: 'Allyriadau y corff adrodd, 2021–2025',
      emissionsPerBodySubtitle: 'Cyfanswm yr allyriadau wedi’i rannu â nifer y cyrff adrodd bob blwyddyn.',
      emissionsPerBodyExploreBtn: 'Gweld y dadansoddiad yn ôl ffynhonnell',
      emissionsPerBodyModalLabel: 'Allyriadau sector cyhoeddus Cymru yn ôl ffynhonnell',
      perBodyFactCaption: 'Wrth ddadansoddi data ar gyfer 67 corff cyhoeddus yn unig a adroddodd yn 2021-22 a 2024-25 — bu cynnydd o',
      perBodyFactSub: 'yn yr allyriadau carbon a adroddwyd',
      ...
      donutBody: 'Allyriadau anuniongyrchol yw allyriadau Cwmpas 3. Cwmpas 3 sy’n gyfrifol am y rhan fwyaf o’r allyriadau, ond cytunir yn eang nad yw’r data’n ddigon cywir i lywio camau ystyrlon.',
      donutCenterShareLabel: 'Cyfanswm allyriadau',
      donutCenterUnit: 'tCO₂e',
      donutScope1Label: 'Cwmpas 1',
      donutScope2Label: 'Cwmpas 2',
      donutScope3Label: 'Cwmpas 3',
      scopeTrendExploreBtn: 'Gweld tueddiad 2021–2025',
